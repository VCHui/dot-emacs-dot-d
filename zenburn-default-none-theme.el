...
(custom-theme-set-faces
 ...
 '(ruler-mode-column-number ((t (:inherit (quote ruler-mode-default) :foreground "#DCDCCC"))))
 '(ruler-mode-fill-column ((t (:inherit (quote ruler-mode-default) :foreground "#F0DFAF"))))
 '(ruler-mode-goal-column ((t (:inherit (quote ruler-mode-fill-column)))))
 '(ruler-mode-comment-column ((t (:inherit (quote ruler-mode-fill-column)))))
 '(ruler-mode-tab-stop ((t (:inherit (quote ruler-mode-fill-column)))))
...
(provide-theme 'zenburn-default-none)
